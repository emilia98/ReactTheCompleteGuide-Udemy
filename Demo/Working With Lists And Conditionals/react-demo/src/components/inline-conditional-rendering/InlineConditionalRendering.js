...
class InlineConditionalRendering extends Component {
    state = {
        persons: [
            { name: 'Emilia', age: 22 },
            { name: 'Max', age: 28 },
    ...
    render() {
        ...
        return (
            <div className="page-container text-center">
                <h1 className="display-3 page-title">Inline Conditional Rendering</h1>
                ...
                <div>
                    <Link className="btn btn-primary mt-3" to="/inline-conditional-rendering/code">To Code</Link>
                </div>
            </div>
        )
    }
